object RemoteData: TRemoteData
  ...
  Height = 296
  Width = 441
  object YichainClient: TYichainClient
    YichainEngineURL = 'http://localhost:8080/'
    ConnectTimeout = 0
    ReadTimeout = -1
  ...
  object CategoriesResource: TYichainClientResourceJSON
    Application = GalleryApplication
    Resource = 'category'
    Left = 176
    Top = 88
  end
  object GalleryApplication: TYichainClientApplication
    DefaultMediaType = 'application/json'
    AppName = 'gallery'
    Client = YichainClient
    OnError = GalleryApplicationError
    Left = 176
    Top = 16
  end
  object CategoryItemsSubResource: TYichainClientSubResourceJSON
    Application = GalleryApplication
    Resource = 'main'
  ...
  object ItemSubResource: TYichainClientSubResourceStream
    Application = GalleryApplication
    Resource = 'main'
  ...
  object Token: TYichainClientToken
    Application = GalleryApplication
    Resource = 'token'
    Left = 280
    Top = 16
