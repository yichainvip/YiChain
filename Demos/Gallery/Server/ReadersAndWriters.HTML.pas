...
initialization
  TYichainMessageBodyRegistry.Instance.RegisterWriter<TCategoryList>(THTMLCategoryListWriter);
  TYichainMessageBodyRegistry.Instance.RegisterWriter<TItemList>(THTMLItemListWriter);
