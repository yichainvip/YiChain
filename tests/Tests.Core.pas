...
, Yichain.Core.URL, Yichain.Core.Utils
;

type
  [TestFixture('URL')]
  TYichainCoreTest = class(TObject)
  private
  public
  ...
  [TestFixture('Utils')]
  TYichainCoreUtilsTest = class(TObject)
  private
  public
  ...
  TYichainRecordToJSONTest = class(TObject)
  private
  public
  ...
  TYichainJSONToRecordTest = class(TObject)
  private
  public
    [Test] procedure Basic;
  end;
  ...
  TYichainRecordFromDataSetTest = class(TObject)
  private
  public
    [Test] procedure Basic;
  end;
...
, Yichain.Core.JSON, Yichain.Rtti.Utils
, Tests.Records.Types
;

procedure TYichainCoreTest.ParseBase;
var
  LURL: TYichainURL;
begin
  LURL := TYichainURL.Create('http://localhost:8080/rest/default/helloworld');
  try
...
procedure TYichainCoreTest.PathParams;
var
  LPrototype, LURL: TYichainURL;
begin
  LPrototype := TYichainURL.Create(
...
procedure TYichainCoreTest.QueryParams;
var
  LURL: TYichainURL;
begin
  LURL := TYichainURL.Create(
...
procedure TYichainCoreTest.URLMatching;
var
  LURL: TYichainURL;
begin
  LURL := TYichainURL.Create('http://localhost:8080/rest/default/helloworld');
...
{ TYichainRecordToJSONTest }

procedure TYichainRecordToJSONTest.AssignedValues;
var
...
procedure TYichainRecordToJSONTest.Basic;
var
...
procedure TYichainRecordToJSONTest.JSONNameAttribute;
var
  LJSONObj: TJSONObject;
...
{ TYichainCoreUtilsTest }

procedure TYichainCoreUtilsTest.GuessTValueFromStr;
var
  LValue: TValue;
begin
...
{ TYichainRecordFromDataSetTest }

procedure TYichainRecordFromDataSetTest.Basic;
type
  TMyRecord = record
    MyString: string;
    MyInteger: Integer;
...
{ TYichainJSONToRecordTest }

procedure TYichainJSONToRecordTest.Basic;
var
  LJSONObj: TJSONObject;
...
initialization
  TDUnitX.RegisterTestFixture(TYichainCoreTest);
  TDUnitX.RegisterTestFixture(TYichainCoreUtilsTest);
  TDUnitX.RegisterTestFixture(TYichainRecordToJSONTest);
  TDUnitX.RegisterTestFixture(TYichainJSONToRecordTest);
  TDUnitX.RegisterTestFixture(TYichainRecordFromDataSetTest);
