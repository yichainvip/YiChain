...
type
  ...
  TYichainRecordWriterTest = class(TObject)
  private
  ...
  [TestFixture('MBW_Records')]
  TYichainArrayOfRecordWriterTest = class(TObject)
  private
    FMBW: IMessageBodyWriter;
    FJSONMediaType: TMediaType;
    FOutputStream: TStringStream;
...
{ TYichainRecordWriterTest }

procedure TYichainRecordWriterTest.Setup;
begin
  FMBW := GetRecordMBW;
...
procedure TYichainRecordWriterTest.TearDown;
begin
  FMBW := nil;
  FJSONMediaType.Free;
  FOutputStream.Free;
...
procedure TYichainRecordWriterTest.Nested;
var
  LRecordValue: TValue;
...
procedure TYichainRecordWriterTest.PrimitiveTypes;
var
...
procedure TYichainRecordWriterTest.Simple;
var
...
{ TYichainArrayOfRecordWriterTest }

procedure TYichainArrayOfRecordWriterTest.Setup;
begin
...
procedure TYichainArrayOfRecordWriterTest.TearDown;
begin
  FMBW := nil;
  FJSONMediaType.Free;
  FOutputStream.Free;
...
procedure TYichainArrayOfRecordWriterTest.Empty;
var
  LValue: TValue;
  LJSONArr: TJSONArray;
begin
...
procedure TYichainArrayOfRecordWriterTest.Items;
var
  LValue: TValue;
  LJSONArr: TJSONArray;
  LJSONObj: TJSONObject;
...
procedure TYichainArrayOfRecordWriterTest.NestedArrays;
var
...
procedure TYichainArrayOfRecordWriterTest.NestedRecords;
var
  LValue: TValue;
  LJSONArr: TJSONArray;
  LJSONObj: TJSONObject;
...
procedure TYichainArrayOfRecordWriterTest.SingleItem;
var
  LValue: TValue;
  LJSONArr: TJSONArray;
  LJSONObj: TJSONObject;
...
initialization
  TDUnitX.RegisterTestFixture(TYichainRecordWriterTest);
  TDUnitX.RegisterTestFixture(TYichainArrayOfRecordWriterTest);
