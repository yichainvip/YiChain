...
, Yichain.Core.MessageBodyReader
...
type
  ...
  TYichainRecordReaderTest = class(TObject)
  private
  ...
  [TestFixture('MBR_Records')]
  TYichainArrayOfRecordReaderTest = class(TObject)
  private
    FMBR: IMessageBodyReader;
    FJSONMediaType: TMediaType;
...
{ TYichainRecordReaderTest }

procedure TYichainRecordReaderTest.Nested;
var
  LValue: TOuterRecord;
  LData: TBytes;
begin
...
procedure TYichainRecordReaderTest.PrimitiveTypes;
var
...
procedure TYichainRecordReaderTest.Simple;
var
...
procedure TYichainRecordReaderTest.Setup;
begin
  FMBR := GetRecordMBR;
...
procedure TYichainRecordReaderTest.TearDown;
begin
  FMBR := nil;
  FJSONMediaType.Free;
end;

{ TYichainArrayOfRecordReaderTest }

procedure TYichainArrayOfRecordReaderTest.Empty;
var
...
procedure TYichainArrayOfRecordReaderTest.Items;
var
...
procedure TYichainArrayOfRecordReaderTest.NestedArrays;
var
...
procedure TYichainArrayOfRecordReaderTest.NestedRecords;
var
...
procedure TYichainArrayOfRecordReaderTest.SingleItem;
var
  LValue: TArray<TPersonRecord>;
  LData: TBytes;
begin
...
procedure TYichainArrayOfRecordReaderTest.Setup;
begin
...
procedure TYichainArrayOfRecordReaderTest.TearDown;
begin
  FMBR := nil;
  FJSONMediaType.Free;
end;
...
initialization
  TDUnitX.RegisterTestFixture(TYichainRecordReaderTest);
  TDUnitX.RegisterTestFixture(TYichainArrayOfRecordReaderTest);
